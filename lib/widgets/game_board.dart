...
class GameBoard extends StatefulWidget {
  ...
  const GameBoard({super.key, required this.gameModel, this.blockSkin = BlockSkin.flat});
        ...
        Screenshot(
          ...
          child: AspectRatio(
            ...
            itemBuilder: (context, index) {
              ...
              final piecePoints = widget.gameModel.currentPiece != null
                  ? widget.gameModel.getPiecePoints(
              ...
              final color = isPiece ? Colors.red : widget.gameModel.grid[y][x];
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            if (image != null) {
              ...
              final imagePath = await File('${directory.path}/screenshot.png').writeAsBytes(image);
              await Share.shareXFiles([XFile(imagePath.path)], text: 'Check out my score on Tetras!');
            }
          },
